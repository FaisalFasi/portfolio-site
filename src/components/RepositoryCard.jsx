...
const RepositoryCard = (props) => {
  return (
    <a href={props.repo.projectLink} target="_blank">
      <div className="flex flex-col items-start w-full lg:w-[50%] mt-8 px-6 py-4 shadow-lg drop-shadow-lg border border-solid rounded-[8px] hover:-translate-y-1  transition-all duration-200">
